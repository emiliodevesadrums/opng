		...
		<table width="50%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
			<tr>
				<td colspan="5" align="right" bgcolor="#E6E6E6">
					<a href="pastebin.php"><strong>Create New Topic</strong></a>
				</td>
			</tr>
			<tr>
				<td width="6%" align="center" bgcolor="#E6E6E6">
					<strong><font color="#000">ID#</font></strong>
				</td>
				<td width="53%" align="center" bgcolor="#E6E6E6">
					<strong><font color="#000">Topic</font></strong>
				</td>
				<td width="13%" align="center" bgcolor="#E6E6E6">
					<strong><font color="#000">Date</font></strong>
				</td>
			</tr>
			...
			<tr>
				...
				<td bgcolor="#E6E6E6">
					<a href="view.php?id=<? echo $rows['ID']; ?>"><? echo $rows['Topic']; ?></a><BR>
				</td>
			...
			<tr>
				<td colspan="5" align="right" bgcolor="#E6E6E6"><a href="pastebin.php">
					<strong>Create New Topic</strong> </a>
				</td>
			</tr>
		</table>
